document.addEventListener('DOMContentLoaded', () => {
  ...
  const stories = {
    tableware: {
      ...
      body: [
        '食事は、生きていくうえで欠かせない毎日の時間。お気に入りのうつわがあるだけで、盛り付けが楽しくなり、いつものお惣菜さえ少し特別に見えます。',
        'マルミツポテリのうつわには、一つひとつに名前と物語があり、使い心地の良さや美しさ、そこに込められた想いに惹かれ、Remindはこのうつわを選びました。',
        '今日は、どのうつわにしよう。そんな小さな楽しみを、毎日の食卓へ。'
      ],
    ...
    taste: {
      ...
      body: [
        ...
        '素材へのこだわりや製法、生産者の想い。知るほどに、誰かにもすすめたくなる。',
    ...
    art: {
      ...
      body: [
        ...
        'ただ飾るだけではなく、その存在によって空間が整い、心まで少し豊かになる。Remindでは、そこにあるだけで、空間も心も整えてくれるものを選んでいます。',
