document.addEventListener('DOMContentLoaded', () => {
  ...
  const stories = {
    tableware: {
      ...
      body: [
        '食事は、生きていくうえで欠かせない毎日の時間です。お気に入りのうつわがあるだけで、盛り付けが楽しくなり、いつものお惣菜さえ少し特別に見えてくる。',
        'マルミツポテリのうつわには、一つひとつに名前と物語があります。使い心地や美しさ、そこに込められた想いにも惹かれ、Remindはこのうつわを選びました。',
        '今日は、どのうつわにしよう。そんな小さな楽しみを、毎日の食卓に。'
      ],
      main: { src: 'images/IMG_8519.JPG', alt: '店内に並ぶ青緑色のうつわ' },
      sub: { src: 'images/IMG_8522.JPG', alt: 'テーブルに並ぶ白いうつわとティーポット' }
    },
    taste: {
      kicker: 'II / TASTE', title: '美味', english: 'Taste',
      lead: 'からだ想いの、美味しい時間。',
      body: [
        'からだに良いものを選ぶことは、昔から大切にしてきました。でも、心を動かされたのは、「えっ、からだにいいのに、こんなに美味しいの。」という驚きでした。',
        '素材へのこだわりや、生産者の想いを知るほど、誰かにもすすめたくなる。Remindには、私自身が味わい、心から美味しいと思ったものを並べています。',
        'からだを想うことが、我慢ではなく、楽しみになるように。'
      ],
      main: { src: 'images/IMG_8458.JPG', alt: 'はちみつやグラノーラなどの食品' },
      sub: { src: 'images/IMG_8465.JPG', alt: 'リボンで包まれた食品のギフト' }
    },
    beauty: {
      kicker: 'III / BEAUTY', title: '美肌', english: 'Beauty',
      lead: '肌も、心も、ときめく美容。',
      body: [
        '一日一日、年齢を重ねていくことは止められません。でも、少しだけあらがうことはできる。',
        '使うたびに、「これ、すごい。」と思わず笑顔になる。そんな小さな感動は、肌だけでなく、心まで前向きにしてくれます。',
        '鏡を見る時間が、昨日より少し楽しみになるように。'
      ],
      main: { src: 'images/IMG_8461.JPG', alt: '店内に並ぶ美容アイテム' },
      sub: { src: 'images/IMG_8480.JPG', alt: '鏡とアクセサリーが並ぶ店内' }
    },
    art: {
      kicker: 'IV / ART', title: '美鑑', english: 'Art',
      lead: '空間に、ときめきが宿る。',
      body: [
        '慌ただしい毎日のなかだからこそ、ふと目に入る美しさを大切にしたいと思っています。',
        'ただ飾るだけではなく、その存在によって空間が整い、心まで少し豊かになる。Remindでは、私自身が思わず足を止め、何度も眺めたくなったものを選んでいます。',
        '暮らしのなかに、心がふっとほどける景色を。'
      ],
      main: { src: 'images/IMG_8450.JPG', alt: '店内に飾られた色彩豊かなアート作品' },
      sub: { src: 'images/IMG_3375.JPG', alt: 'アートやオブジェが並ぶ店内' }
    }
  };
